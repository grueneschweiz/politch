			...
			$meta_boxes[] = array(
				...
				'fields'     => array(
					array(
						...
						'desc' => __('Year of birth. Ex: 1970','politch' ),
					...
					array(
						...
						'desc' => _x('Hometown', 'Place of residence','politch' ),
						'id'   => $prefix . 'city',
						'type' => 'text',
						'std'  => ''
					),
					...
					array(
						...
						'desc' => __('Very short curivulum vitae (2-3 lines).','politch' ),
						'id'   => $prefix . 'brief_cv',
						'type' => 'textarea',
						'std'  => '',
						'rows' => 3
					...
					array(
						...
						'desc' => __('List of organizations where this person has mandates. Use one line per organization.','politch' ),
						'id'   => $prefix . 'mandates',
						'type' => 'textarea',
						'std'  => '',
						'rows' => 5
					...
					array(
						...
						'desc' => __('List of organizations where this person is a member of. Use one line per organization.','politch' ),
			...
			$meta_boxes[] = array(
				...
				'fields'     => array(
					array(
						...
						'desc' => __('Name of the electoral list.','politch' ),
					...
					array(
						...
						'desc' => __('Number of the electoral list.','politch' ),
					...
					array(
						...
						'desc' => __('Number of the candidate on the ticket','politch' ),
					...
					array(
						...
						'desc' => __('Electoral district','politch' ),
						'id'   => $prefix . 'district',
						'type' => 'text',
						'std'  => ''
					),
					...
					array(
						...
						'desc' => __('Please upload smartspider','politch' ),
